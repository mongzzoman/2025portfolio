$(document).ready(function(){
    ...
    $('#toggle').on('click',function(){
      ...
      $('.introduce .btns').toggleClass('dark');
      ...
      $('.design .content .image-box').toggleClass('dark');
      $('.design .content .explain p').toggleClass('dark');
      $('.design .content .explain h2').toggleClass('dark');

      $('.works .contents .content .explain .tag li').toggleClass('dark');
      $('.works .content .explain .btns').toggleClass('dark');
      $('.works .content .explain .btns a').toggleClass('dark');
      $('.works .content .explain button').toggleClass('dark');
